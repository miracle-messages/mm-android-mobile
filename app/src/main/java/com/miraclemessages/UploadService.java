...
public class UploadService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String chosenAccountName = intent.getStringExtra(UploadActivity.ACCOUNT_KEY);

        credential =
                GoogleAccountCredential.usingOAuth2(getApplicationContext(), Lists.newArrayList(AuthClass.SCOPES));
...
//            cursor.moveToFirst();
            ...
            videoId = ResumableUpload.upload(youtube, fileInputStream, fileSize, mFileUri, sharedPreferences.getString(FileLoc, null).toString(), getApplicationContext());
