...
import com.miraclemessages.util.Utils;
import com.miraclemessages.util.VideoData;
import com.miraclemessages.UploadsListFragment;
...
public class UploadActivity extends Activity implements
     ...
     * static variables defined in {@link AuthClass} and {@link Constants}.
     */
        ...
        new AsyncTask<Void, Void, List<VideoData>>() {
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Utils.logAndShow(UploadActivity.this, Constants.APP_NAME, e);
                }
                return null;
            }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, UploadActivity.this,
